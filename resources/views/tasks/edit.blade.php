...
<body class="bg-gray-100">
    <section class="container mx-auto p-8">
        <h1 class="text-3xl font-bold mb-6 text-center">Editar Tarea</h1>
            ...
            <form action="{{ route('tasks.update', $task) }}" method="POST">
                ...
                <section class="mb-4">
                    ...
                    <textarea id="description" name="description"
                        class="w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('description', $task->description) }}</textarea>
                </section>
